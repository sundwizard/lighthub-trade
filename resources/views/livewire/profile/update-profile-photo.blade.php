                ...
                <div class="card card-bordered">
                    <div class="card-aside-wrap">
                        <div class="card-inner card-inner-lg">
                            ...
                            <div class="nk-block">
                                <form wire:submit.prevent="uploadProfilePhoto">
                                <div class="row gy-4">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <div class="form-control-wrap">
                                                @if($photo)
                                                    @if($errors->has('photo'))
                                                        <img style="border-radius: 10px;" src="{{ asset('assets/photo/'.Auth::user()->profile_photo_path) }}" width="200" alt="">
                                                    @else
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                <div wire:ignore class="form-file">
                                                    <input type="file" wire:model="photo" class="form-file-input" id="customMultipleFiles">
