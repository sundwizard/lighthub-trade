                                ...
                                <div class="col-lg-8">
                                    <div class="card card-bordered h-100">
                                        <div class="card-inner">
                                            <div class="card-head">
                                                <h1 class="overline-title-alt title">Funds Deposit</h1>
                                            </div><hr>
                                            <form action="#" wire:submit.prevent="depositFunds">
                                                @csrf
                                                ...
                                                <div style="margin-left: 50%" wire:loading wire:target="depositFunds" ><x-loader /></div>
                                                <div class="form-group">
                                                    <button type="submit"   class="btn btn-lg btn-secondary">Deposit Funds</button>
                                                </div>
