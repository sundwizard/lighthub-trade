<div>
    <x-slot name="title">Staff Creation </x-slot>
                                ...
                                <div class="col-lg-8">
                                    <div class="card card-bordered h-100">
                                        <div class="card-inner">
                                            <div class="card-head">
                                                <h1 class="overline-title-alt title">Staff Registration</h1>
                                            </div><hr>
                                            <form action="#" wire:submit.prevent="RegisterStaff">
                                                @csrf
                                                <div class="row">
                                                    <div class="col-md-6">
                                                ...
                                                <div style="margin-left: 50%" wire:loading wire:target="RegisterStaff" ><x-loader /></div>
                                                <div class="form-group">
                                                    <button type="submit"   class="btn btn-lg btn-secondary">Register Staff</button>
                                                </div>
