                            ...
                            <td style="background-color:#000000" align="center">
                                <div style="background-color: #fff;">
                                    <div
                                        ...
                                        <div style="border-collapse: collapse; display: table; width: 100%; ">
                                            <table style="background-color:rgba(255, 255, 255, 0.725);" width="100%" cellspacing="0"
                                                                                                                    ...
                                                                                                                    <tr
                                                                                                                        ...
                                                                                                                        <td style="padding-right: 0px;padding-left: 0px;"
                                                                                                                            ...
                                                                                                                            <img style="text-decoration: none; -ms-interpolation-mode: bicubic; height: auto; border: 0; width: 100%; max-width: 130px; display: block;"
                                                                                                                                title="your logo"
                                                                                                                                alt="your logo"
                                                                                                                                src="https://www.genethan.com.ng/ncc-logos.png"
                                                                                                                                width="130"
                                                                                                                                border="0"
                                                                                                                                align="middle">
                                                                                                                            <div
                                ...
                                <div style="background-color: #fff;">
                                    <div
                                        ...
                                        <div
                                            style="border-collapse: collapse; display: table; width: 100%; background-color: #f1d0ff; background-image: url('https://nacomns.fra1.digitaloceanspaces.com/kasuwan-kano/assets/images/mail/verify.png'); background-position: top left; background-repeat: no-repeat;">
                                                                                                    ...
                                                                                                    <div
                                                                                                                        ...
                                                                                                                        <div
                                                                                                                            ...
                                                                                                                            <div
                                                                                                                                ...
                                                                                                                                <p
                                                                                                                                    ...
                                                                                                                                    <span
                                                                                                                                        style="font-size: 18px; color: #fff;">you got this mail because you requested for a password reset</span>
                                                                                                                                </p>
                                                                                                                                <p
                                                                                                                                    style="text-align: center; line-height: 1.5; word-break: break-word; font-family: 'Cabin', Arial, 'Helvetica Neue', Helvetica, sans-serif; font-size: 18px; mso-line-height-alt: 27px; margin: 0;">
                                                                                                                                    <span
                                                                                                                                        style="font-size: 18px; color: #fff;">Kindly
                                                                                                                                        click
                                                                                                                                        the
                                                                                                                                        button
                                                                                                                                        below
                                                                                                                    ...
                                                                                                                    <td
                                                                                                                        ...
                                                                                                                        <div
                                                                                                                            ...
                                                                                                                            <div
                                                                                                                                ...
                                                                                                                                <span
                                                                                                                                    style="font-size: 15px; color: #fff; mso-ansi-font-size: 14px;">If
                                                                                                                                    you
                                                                                                                                    did
                                                                                                                                    make
                                                                                                                                    this
                                                                                                                                                ...
                                                                                                                                                target="_blank"><span
                                                                                                                                                    style="padding-left: 40px; padding-right: 40px; font-size: 14px; display: inline-block; letter-spacing: undefined;"><span
                                                                                                                                                        style="font-size: 16px; line-height: 2; word-break: break-word; font-family: 'Cabin', Arial, 'Helvetica Neue', Helvetica, sans-serif; mso-line-height-alt: 32px;"><span
                                                                                                                                                            style="font-size: 14px; line-height: 28px;">Create Password</span></span></span></a>
                                                                                                                                        </center>
                                                                                                                                    </v:textbox>
                                                                                                                                </w:anchorlock>
                                                                                                                            </v:roundrect>
                                                                                                        ...
                                                                                                        <table
                                                                                                            ...
                                                                                                            <tbody>
                                                                                                                <tr>
                                                                                                                    <td
                                                                                                                        style="padding-right: 10px; padding-left: 10px; padding-top: 10px; padding-bottom: 15px; font-family: Arial, sans-serif">
                                                                                                                        <div
                                                                                                                            style="color: #fff; font-family: 'Cabin', Arial, 'Helvetica Neue', Helvetica, sans-serif; line-height: 1.2; padding: 10px 10px 15px 10px;">
                                                                                                                            <div
                                                                                                        ...
                                                                                                        <table
                                                                                                            ...
                                                                                                            <tbody>
                                                                                                                <tr>
                                                                                                                    <td
                                                                                                                        style="padding-right: 10px; padding-left: 10px; padding-top: 10px; padding-bottom: 20px; font-family: Arial, sans-serif">
                                                                                                                        <div
                                                                                                                            style="color: #393d47; font-family: Arial, Helvetica Neue, Helvetica, sans-serif; line-height: 1.2; padding: 10px 10px 20px 10px;">
                                                                                                                            <div
                                                                                                                                ...
                                                                                                                                <p
                                                                                                                                    ...
                                                                                                                                    <span
                                                                                                                                        style="color: #fff;">Nigerian Communication Comision&copy;
                                                                                                                                        .
                                                                                                                                        <a style="color: #fff;font-weight: 600;"
                                                                                                                                            href="http://[unsubscribe]/"
                                                                                                                                            target="_blank"
                                                                                                                                            rel="noopener"></a></span>
                                                                                                                                </p>
                                                                                                                            </div>
                                                                                                    ...
                                                                                                    <div
                                                                                                        ...
                                                                                                        <table
                                                                                                            ...
                                                                                                            <tbody>
                                                                                                                <tr>
                                                                                                                    <td
                                                                                                                        style="padding-right: 0px; padding-left: 0px; padding-top: 0px; padding-bottom: 0px; font-family: Arial, sans-serif">
                                                                                                                        <div
                                                                                                                                    ...
                                                                                                                                    <td style="word-break: break-word; vertical-align: top; padding-bottom: 0; padding-right: 2.5px; padding-left: 2.5px;"
                                                                                                                                        ...
                                                                                                                                        <a href="https://www.facebook.com/"
                                                                                                                                            target="_blank"><img
                                                                                                                                                ...
                                                                                                                                                title="facebook"
                                                                                                                                                src="assets/images/email-template/facebook_2.png"
                                                                                                                                                alt="Facebook"
                                                                                                                                                width="32"
                                                                                                                                                height="32"></a>
                                                                                                                                    </td>
                                                                                                                                    <td style="word-break: break-word; vertical-align: top; padding-bottom: 0; padding-right: 2.5px; padding-left: 2.5px;"
                                                                                                                                        ...
                                                                                                                                        <a href="https://www.instagram.com/"
                                                                                                                                            target="_blank"><img
                                                                                                                                                style="text-decoration: none; -ms-interpolation-mode: bicubic; height: auto; border: 0; display: block;"
                                                                                                                                                title="facebook"
                                                                                                                                                src="assets/images/email-template/instagram_2.png"
                                                                                                                                                alt="Facebook"
                                                                                                                                                width="32"
                                                                                                                                                height="32"></a>
                                                                                                                                    </td>
                                                                                                                                    <td style="word-break: break-word; vertical-align: top; padding-bottom: 0; padding-right: 2.5px; padding-left: 2.5px;"
                                                                                                                                        ...
                                                                                                                                        <a href="https://www.twitter.com/"
                                                                                                                                            target="_blank"><img
                                                                                                                                                style="text-decoration: none; -ms-interpolation-mode: bicubic; height: auto; border: 0; display: block;"
                                                                                                                                                title="twitter"
                                                                                                                                                src="assets/images/email-template/twitter_2.png"
                                                                                                                                                alt="Twitter"
                                                                                                                                                width="32"
                                                                                                                                                height="32"></a>
                                                                                                                                    </td>
