...
(function (NioApp, $) {
  ...
  $('.confirm-start').on("click", function (e) {
    Swal.fire({
      title: 'Are you sure?',
      text: "are you really sure you want to start trade!",
      icon: 'warning',
      showCancelButton: true,
      confirmButtonText: 'Yes, start trade!'
    }).then(function (result) {
      if (result.value) {
         Livewire.emit('start-confirmed')
      }
    });
    e.preventDefault();
  });
  $('.confirm-enable').on("click", function (e) {
    Swal.fire({
      title: 'Are you sure?',
      text: "are you really sure you want to enable this Staff!",
      icon: 'warning',
      showCancelButton: true,
      confirmButtonText: 'Yes, enable user!'
    }).then(function (result) {
      if (result.value) {
         Livewire.emit('enable-confirmed')
      }
    });
    e.preventDefault();
  });
  $('.confirm-reset').on("click", function (e) {
    Swal.fire({
      title: 'Are you sure?',
      text: "are you really sure you want to reset this Staff Password!",
      icon: 'warning',
      showCancelButton: true,
      confirmButtonText: 'Yes, reset staff password!'
    }).then(function (result) {
      if (result.value) {
         Livewire.emit('reset-confirmed')
      }
    });
    e.preventDefault();
  });
